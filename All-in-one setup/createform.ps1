...
$delegatedFormCategories = @("Exchange Online","User Management","Mailbox Management") #Only unique names are supported. Categories will be created if not exists
...
'@; 
	...
	$tmpVariables = @'
[{"name":"permission","value":"{{form.permission}}","secret":false,"typeConstraint":"string"},{"name":"identity","value":"{{form.gridMailbox.id}}","secret":false,"typeConstraint":"string"},{"name":"usersToRemove","value":"{{form.permissionList.rightToLeft.toJsonString}}","secret":false,"typeConstraint":"string"},{"name":"usersToAdd","value":"{{form.permissionList.leftToRight.toJsonString}}","secret":false,"typeConstraint":"string"}]
'@ 
